...
| Frontend: mark watched ✅; not watched ✅ (via a triad replacement only); watchlist ✅ (from a recommendation; listed in `ListScreen`); history ✅ (`ListScreen`); state shown in search ❌ | 🟡 | 🟡 | `§4.2`, `§5.1` |
