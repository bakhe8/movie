...
| Item | Built | Blueprint | Evidence / gap |
|---|---|---|---|
| Backend unit tests (7 files, 87 tests) | ✅ | — | re-run 2026-09-03; +8 with the gap-3 triad rework, +3 with the H1 title-reuse fix, +12 with the ADR-17 replacement endpoint, +5 with the library ranking |
