...
| [ARCHITECTURE_DECISIONS.md](ARCHITECTURE_DECISIONS.md) | EN | decisions | ADR-1…117 — every engineering choice with its blueprint anchor and revisit trigger |
...
| [APPEARANCE_STRUCTURE_PLAN_2026-09-06.md](APPEARANCE_STRUCTURE_PLAN_2026-09-06.md) | AR | proposed implementation plan | T1 under ADR-115: featured-recommendation journey, sequential C1/P1/M1 structural candidates, shared truth, ownership, local checks and visual adoption gates; documentation does not authorize implementation |
| [ADMIN_CONTROL_CENTER_2026-09-06.md](ADMIN_CONTROL_CENTER_2026-09-06.md) | AR | audit and proposed execution plan | owner constraints, current-function preservation map, monitoring/administration split, responsive admin shell, W0-W8 gates and verification plan; documentation does not authorize premature jobs, settings or experiment controls |
| [ADMIN_W0_PRESERVATION_CONTRACT_2026-09-06.md](ADMIN_W0_PRESERVATION_CONTRACT_2026-09-06.md) | EN | W0 preservation contract | source-checked function/test/destination matrix at `dee0cd3`, ADR-117, exclusive file ownership, compatibility wrapper, merge order and W1/first-package stop gates; documentation only |
...
| 2026-09-06 | Added the T1 structural planning record, preserving proposed status and the theme/appearance distinction; no product implementation |
| 2026-09-06 | Added the owner-requested administrative control-center audit and staged W0-W8 execution plan; no product implementation or authorization of gated jobs, settings or experiment controls |
| 2026-09-06 | Added the W0 preservation contract and ADR-117; refreshed the ADR index through 117, restored missing summary rows 113/114 and joined row 116 to the table without changing its wording or ADR-116's body; no product implementation |
