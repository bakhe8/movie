...
| [ARCHITECTURE_DECISIONS.md](ARCHITECTURE_DECISIONS.md) | EN | decisions | ADR-1…26 — every engineering choice with its blueprint anchor and revisit trigger |
...
| Frontend | [SPECIFICATION.md](SPECIFICATION.md) §5, [API.md](API.md), blueprint `§4`, `§9.3`–`§9.4`, ADR-5/20/21 |
